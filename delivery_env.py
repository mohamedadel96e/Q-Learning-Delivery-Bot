...
class DeliveryEnv(gym.Env):
    ...
    def _draw_traffic_signals(
        ...
        for x, y in ((4, 4), (5, 4), (4, 5), (5, 5)):
            rect = self._cell_rect(x, y)
            box = pygame.Rect(0, 0, 10, 24)
            box.center = (rect.centerx, rect.centery)
            pygame.draw.rect(surface, colors["outline"], box, border_radius=3)
            pygame.draw.circle(surface, colors["signal_red"], (box.centerx, box.top + 5), 3)
            pygame.draw.circle(surface, colors["signal_yellow"], box.center, 3)
            pygame.draw.circle(surface, colors["signal_green"], (box.centerx, box.bottom - 5), 3)
